...
class HashTag {
  ...
  bool trending;
  int? last24;
  HashTag({required this.hashtag, this.subtitle, this.trending = false, this.last24});
...
class Matched {
  ...
  @override
  String toString() => 'display: $display value: $value start: $start end: $end';
}
...
abstract class ParserType {
  ...
  ParserType({this.pattern, this.style, this.onTap, this.renderText});
}
